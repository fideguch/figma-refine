...
| Status | Label | Badge BG | Text Color | Use Case |
|--------|-------|----------|------------|----------|
| Unread | 未読 | #FFF7ED | #F59E0B | 新規配置、未処理 |
| Read | 既読 | #EFF6FF | #3B82F6 | 処理中 or 修正適用済み・検証待ち |
| Done | 完了 | #F0FDF4 | #10B981 | 3層検証パス済み |
...
statusText.fills = [{ type: 'SOLID', color: { r: 0.96, g: 0.62, b: 0.04 } }];
